...
function BackgroundCircles() {
  return (
    ...
    >
      ...
      <div className=" border rounded-full border-solid border-[#d3e97a] opacity-20 h-[650px] w-[650px] mt-[37rem] absolute " />
      <div className=" border rounded-full border-solid border-[#333333] opacity-20 h-[800px] w-[800px] mt-[37rem] bg-[#1f1f1f]  absolute  animate-pulse " />
    </motion.div>
  );
}
